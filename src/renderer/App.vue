          ...
          <el-table size="mini"
            ...
            <el-table-column
              ...
              <template slot-scope="scope">
                ...
                <el-button @click="setDefAddress(scope.row,scope.$index+1)" v-show="scope.row.defaultAddress === false" type="text" size="small">设为默认</el-button>
              </template>
            </el-table-column>
          </el-table>
        </el-tab-pane>
      ...
      <el-dialog
        ...
        <el-form ref="form" :model="sizeForm" label-width="80px" size="mini">
          ...
          <el-form-item label="详细地址">
            <el-input placeholder="请输入详细地址信息，如道路、门牌号、小区、楼栋号、单元等信息" v-model="sizeForm.address"></el-input>
          </el-form-item>
...
export default {
    ...
    methods: {
      login () {
        ...
        async function main () {
          ...
          try {
            ...
            self.isLogin = true
            document.title = await page.evaluate(() => {
              let nickName = document.querySelector('#J_SiteNavLogin > div.site-nav-menu-hd > div.site-nav-user > a.site-nav-login-info-nick') ? document.querySelector('#J_SiteNavLogin > div.site-nav-menu-hd > div.site-nav-user > a.site-nav-login-info-nick').innerText : ''
              return nickName
            })
            self.refreshInfo()
            self.onRequest()
              ...
              page.on('response', response => {
                if (response.url().startsWith('https://h5api.m.taobao.com/h5/mtop.taobao.mbis.getdeliveraddrlist')) {
                  ...
                  message.then(function (result) {
                    ...
                    self.addressData = JSON.parse(result.data.returnValue)
                  })
                }
              })
              request.continue()
      ...
      refreshInfo () {
        ...
        async function main () {
          ...
          if (buyStatus) {
            ...
            self.order.buyStatus = buyStatus
            self.confirmGoodTypeInfo()
          }
        }
        self.refreshTimer = cron.schedule('10 9,19,29,39,49,59 */1 * * *', () => {
          main()
        })
      },
      ...
      setDefAddress (tab, event) {
        async function main () {
          await page.click('#container > div > div.addressList > div.next-table > table > tbody > tr:nth-child(' + event + ') > td.next-table-cell.last > div > div > span')
        }
        main()
      },
      handleChange (value) {
      ...
      searchGoods () {
        ...
        async function main () {
          ...
          self.goodsImgUrl = goodsInfo.goodsImgUrl
          self.startTime = goodsInfo.startTime
          self.goodsJson = goodsInfo.goodsJson
        }
        main()
      },
      ...
      confirmGoodTypeInfo () {
        ...
        async function main () {
          ...
          self.beforeBuyGoods(self.order.buyStatus)
        }
        main()
      },
      beforeBuyGoods (arg) {
